...
public class BusRouteDescription extends AppCompatActivity {

    private ImageView busBtn, locationBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bus_route_description);
        ...
        busBtn.setOnClickListener(new View.OnClickListener() {
            ...
            private void openBusRoutePage() {
                Intent intent = new Intent(BusRouteDescription.this, BusRoutePage.class);
        ...
        locationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            private void openBusSearchPage() {
                Intent intent = new Intent(BusRouteDescription.this, BusSearchPage.class);
                startActivity(intent);
            }
        });
